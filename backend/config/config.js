// main-backend/config/db.js
const { MongoClient } = require('mongodb');
require('dotenv').config();

const MONGO_URI = process.env.MONGO_URI; // put your Mongo URI in .env
const DB_NAME = process.env.DB_NAME || 'myDatabase'; // your DB name
...
/**
 * Get DB instance (call connectDB first in server.js)
 */
function getAdminDb() {
  if (!db) {
...
module.exports = { connectDB, getAdminDb };
